...
const DefectRatePareto = () => {
    const [hoveredIndex, setHoveredIndex] = useState(null);
    const [mousePosition, setMousePosition] = useState({ x: 0, y: 0 });

    // Sample data - replace with your actual data
    const [data, setData] = useState([
        { operation: 'Op2', rejectedQty: 7, producedQty: 200, defectRate: 3.5 },
        { operation: 'Op5', rejectedQty: 12, producedQty: 450, defectRate: 2.67 },
        { operation: 'Op1', rejectedQty: 5, producedQty: 250, defectRate: 2.0 },
        { operation: 'Op3', rejectedQty: 8, producedQty: 400, defectRate: 2.0 },
        { operation: 'Op4', rejectedQty: 3, producedQty: 300, defectRate: 1.0 },
        { operation: 'Op6', rejectedQty: 2, producedQty: 350, defectRate: 0.57 },
    ]);
    ...
    const handleSelectedPeriod = (e) => {
        ...
        if (e.target.value === '2024') {
            setData([
                { operation: 'Op2', rejectedQty: 10, producedQty: 200, defectRate: 5.0 },
                { operation: 'Op5', rejectedQty: 15, producedQty: 450, defectRate: 3.33 },
                { operation: 'Op1', rejectedQty: 8, producedQty: 250, defectRate: 3.2 },
                { operation: 'Op3', rejectedQty: 12, producedQty: 400, defectRate: 3.0 },
                { operation: 'Op4', rejectedQty: 5, producedQty: 300, defectRate: 1.67 },
                { operation: 'Op6', rejectedQty: 3, producedQty: 350, defectRate: 0.86 },
            ]);
        } else {
            setData([
                { operation: 'Op2', rejectedQty: 7, producedQty: 200, defectRate: 3.5 },
...
export default DefectRatePareto;
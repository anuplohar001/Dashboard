...
const OEEHeatmap = () => {
    ...
    const legendItems = [
        { color: "#800000", label: "90 – 100 (Very High)" },
        { color: "#c0392b", label: "80 – 89 (High)" },
        { color: "#e74c3c", label: "70 – 79 (Moderate)" },
        { color: "#f1948a", label: "60 – 69 (Low)" },
        { color: "#f5b7b1", label: "< 60 (Very Low)" },
    ];

    // Color scale function
    const getColor = (value) => {
        if (value >= 90) return "#800000";
        if (value >= 80) return "#c0392b";
        if (value >= 70) return "#e74c3c";
        if (value >= 60) return "#f1948a";
        return "#f5b7b1";
    };
    ...
    return (
        <Card className="card-container border-2 oee">
            <div className='d-flex justify-content-between align-items-center mb-2'>
                <div style={{ fontWeight: "bold", fontSize: "15px" }}>
                    Machine Performance Heatmap (OEE)
                </div>
                <select

                        ...
                        <div className="mb-3 d-flex justify-content-center" style={{ width: "fit-content" }}>
                            <svg width={chartWidth} height={chartHeight + 30} style={{ overflow: 'visible' }}>
                                ...
                                <g transform={`translate(${leftPadding}, ${chartHeight + 25})`}>
                                    ...
                                    <text x="8" y="4" style={{ fontSize: '9px', fill: '#424242ff' }}>Actual</text>

                                    <circle cx="50" cy="0" r="3" fill="#6c757d" />
                                    <text x="58" y="4" style={{ fontSize: '9px', fill: '#424242ff' }}>Target</text>
                                </g>
                            </svg>
                        </div>
                    </div>
...
export default MonthlySalesTrendKPI;
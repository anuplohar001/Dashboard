...
const DowntimeByMachineChart = () => {
    ...
    const downtimeData = [
        { reason: 'Breakdown', hours: 32, percentage: 70, color: '#eb283cff' },
        { reason: 'Preventive', hours: 28, percentage: 15, color: '#ff7300ff' },
        { reason: 'Idle', hours: 20, percentage: 15, color: '#006cdfff' }
    ];
